...
class BasicGymController(BasicController):
    """
    This basic controller only works with Unity or Godot bemakerTesting
    ...
    gym.make("bemakerEnv-v0", controller_class=MyController)

    where MyController is the controller class that you create based
    on bemakeragents.BasicGymController.
    """
    def __init__(self):
        """
    ...
    def reset_behavior(self, info):
        ...
        implemented in the bemakerTesting code.
        """
